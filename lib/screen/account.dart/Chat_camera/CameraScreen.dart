...
//   Future<void> _openCameraPicker(BuildContext context) async {
...
//                     MaterialPageRoute(
//                       builder: (_) => StoryEditorScreen(
//                         image: file, // can generate thumbnail later if needed
//                         filePath: file,
//                         isVideo: true,
//                         currentUserId: currentUserId,
//                       ),
...
//           label: const Text('Open Camera Options'),
//           onPressed: () => _openCameraPicker(context),
//         ),
//       ),
//     );
//   }
