...
import 'package:stitchup/screen/account.dart/Chat_camera/Chat_Camera.dart';
          ...
          actions: [
            PopupMenuButton<String>(
              ...
              onSelected: (value) {
                ...
                // Handle each menu item as needed
              },
              itemBuilder: (BuildContext context) => [
                _buildMenuItem('View contact'),
                _buildMenuItem('Search'),
                _buildMenuItem('Add to list'),
                _buildMenuItem('Media, links, and docs'),
                _buildMenuItem('Mute notifications'),
                _buildMenuItem('Disappearing messages'),
                _buildMenuItem('Chat theme'),
